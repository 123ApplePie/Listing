    <div class="bg-white">
        <div class="max-w-screen-xl mx-auto py-8 md:py-16 bg-white min-h-screen">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="flex flex-col items-center">
                    <span class="font-semibold text-2xl text-[#f84525] block">
                        FAQ
                    </span>
                    <h2 class="font-bold text-3xl md:text-5xl mt-2 tracking-tight text-[#1e3a8a]">
                        Veelgestelde vragen
                    </h2>
                ...
                <div class="max-w-xl mx-auto mt-8">
                    <div class="py-5">
                        <details class="group" open>
                            <summary class="flex justify-between items-center font-medium cursor-pointer list-none">
                                <span class="text-[#1e3a8a]"> Wat is het doel van deze website?</span>
                    ...
                    <div class="py-5">
                        <details class="group">
                            <summary class="flex justify-between items-center font-medium cursor-pointer list-none">
                                <span class="text-[#1e3a8a]"> Hoe kan ik een dierenarts vinden met behulp van deze website?</span>
                                <span class="transition group-open:rotate-180 bg-[#f84525] rounded-full">
                            <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path>
            </svg>
                          </span>
                    ...
                    <div class="py-5">
                        <details class="group">
                            <summary class="flex justify-between items-center font-medium cursor-pointer list-none">
                                <span class="text-[#1e3a8a]"> Zijn alle dierenartsen in mijn regio geregistreerd op deze website?</span>
                                <span class="transition group-open:rotate-180 bg-[#f84525] rounded-full">
                            <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path>
            </svg>
                          </span>
                    ...
                    <div class="py-5">
                        <details class="group">
                            <summary class="flex justify-between items-center font-medium cursor-pointer list-none">
                                <span class="text-[#1e3a8a]"> Kan ik de profielen van de dierenartsen bekijken voordat ik een keuze maak?</span>
                                <span class="transition group-open:rotate-180 bg-[#f84525] rounded-full">
                            <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path>
            </svg>
                          </span>
                    ...
                    <div class="py-5">
                        <details class="group">
                            <summary class="flex justify-between items-center font-medium cursor-pointer list-none">
                                <span class="text-[#1e3a8a]"> Zijn er kosten verbonden aan het gebruik van deze service?</span>
                                <span class="transition group-open:rotate-180 bg-[#f84525] rounded-full">
                            <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path>
            </svg>
                          </span>
                    ...
                    <div class="py-5">
                        <details class="group">
                            <summary class="flex justify-between items-center font-medium cursor-pointer list-none">
                                <span class="text-[#1e3a8a]"> Hoe kan ik contact opnemen met de gekozen dierenarts?</span>
                                <span class="transition group-open:rotate-180 bg-[#f84525] rounded-full">
                            <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path>
            </svg>
                          </span>
                    ...
                    <div class="py-5">
                        <details class="group">
                            <summary class="flex justify-between items-center font-medium cursor-pointer list-none">
                                <span class="text-[#1e3a8a]"> Kan ik mijn ervaringen delen door recensies achter te laten?</span>
                                <span class="transition group-open:rotate-180 bg-[#f84525] rounded-full">
                            <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path>
            </svg>
                          </span>
                    ...
                    <div class="py-5">
                        <details class="group">
                            <summary class="flex justify-between items-center font-medium cursor-pointer list-none">
                                <span class="text-[#1e3a8a]"> Wat moet ik doen als ik een specifieke vraag heb die niet in de FAQ staat?</span>
                                <span class="transition group-open:rotate-180 bg-[#f84525] rounded-full">
                            <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path>
            </svg>
                          </span>
